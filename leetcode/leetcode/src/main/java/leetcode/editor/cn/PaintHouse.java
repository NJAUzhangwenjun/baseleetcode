...
/**
 * 一排 n 栋房子，每栋房子都可以涂上三种颜色中的一种：红色、蓝色或绿色。用某种颜色粉刷每个房子的成本是不同的。你必须给所有的房子涂漆，这样相邻的两个房子就没有相同的颜色。
 * <p>
 * 用某种颜色粉刷每栋房子的成本由  成本矩阵表示。例如，  用红色粉刷房子 0 的成本是costs[0][0]；  costs[1][2]是用绿色粉刷房子 1 的成本，依此类推... 找出粉刷所有房子的最低成本。n x 3costs[0][0]costs[1][2]
 * <p>
 * 注：
 * 所有成本均为正整数。
 * <p>
